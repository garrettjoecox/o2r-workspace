// Message parser for Ocarina of Time / Majora's Mask text messages

import { CONTROL_CODE_NAMES, CONTROL_CODES } from "@/lib/constants/message";

export { CONTROL_CODES, CONTROL_CODE_NAMES };
