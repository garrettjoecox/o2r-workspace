...
import { ResourceEntry, formatHexData } from "@/lib/o2r-parser"
  ...
  return (
    <div className="h-full flex flex-col">
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              ...
              <span className="font-mono">{resource.dataWithoutHeader.length} bytes</span>
            </div>
            <div>
            ...
            <div>
              ...
              <span className="font-mono">{resource.header.resourceVersion}</span>
            </div>
            <div>
              <span className="text-muted-foreground">Custom:</span>{" "}
              <span className="font-mono">{resource.header.isCustom ? "Yes" : "No"}</span>
            </div>
            <div className="col-span-2">
              <span className="text-muted-foreground">Unique ID:</span>{" "}
              <span className="font-mono text-xs">0x{resource.header.uniqueId.toString(16).padStart(16, '0')}</span>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="flex-1 flex flex-col overflow-hidden">
        <CardHeader>
          <CardTitle className="text-base">Hex View (without OTR header)</CardTitle>
